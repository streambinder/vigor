...
6. TRAINING STRUCTURE: How should I organize warmup, work, and cooldown to maximize effectiveness? Describe blocks, exercises, reps/duration, weights, modifiers, and rest times in prose — NEVER emit JSON or code blocks.
