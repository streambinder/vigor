          ...
          _buildCollapsibleSection(
            ...
            children: [
              ...
              if (favEquipment.isNotEmpty) ...[
                ...
                _buildChipWrap(favEquipment.map((e) => KnowledgeLabels.equipmentLabel(e, l10n)).toList()),
              ],
            ],
          ),
        ],
            ...
            Padding(
              ...
              child: Wrap(
                ...
                children: gym.equipment.map((eq) => Container(
                  ...
                  child: Text(KnowledgeLabels.equipmentLabel(eq, l10n), style: VigorTypography.caption.copyWith(color: VigorColors.stone)),
                )).toList(),
              ),
            ),
        ],
