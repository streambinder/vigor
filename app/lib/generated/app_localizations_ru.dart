...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get addACondition => 'Добавить состояние';
  ...
  @override
  String get failedToUpdateFeedback => 'Не удалось обновить отзыв';
  ...
  String get calibrationAutoOnlyHint =>
      'Во время калибровки доступна только автоматическая генерация тренировок — вы по-прежнему можете добавить партнёра, изменить длительность или выбрать зал и оборудование';
